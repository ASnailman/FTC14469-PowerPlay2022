...
//                                RailControlV2.GetTaskState() == Task_State.READY)) {
                    if (BaseControl.GetTaskState() == Task_State.READY || BaseControl.GetTaskState() == Task_State.DONE) {
                        if (coneLevel == 0) {
                            ...
                            if (ET.milliseconds() > 400) {
                                SetAttachmentPositionLowPower(1800, 2545);
                                ET.reset();
                                programOrder++;
                            }
                        }
                ...
                case 15:
                    if (RailControlV2.GetTaskState() == Task_State.DONE || RailControlV2.GetTaskState() == Task_State.READY) {
                        ...
                        if (coneLevel == 0) {
                            ...
                            SetAttachmentPositionLowPower(2170, 2545);
                        }
                        else if (coneLevel == 4) {
...
//                    break;
                ...
                case 16:
                    if (RotatingBase.getCurrentPosition() > 1900 && coneLevel == 3) {
                        SetExtendingPositionLowPower(150);
                    }
