...
@Autonomous(name = "SprintAutoLeftRed2", group = "MecanumDrive")
public class SprintAutoLeftRed2 extends LinearOpMode {
...
//                        SetAttachmentPosition(0, 4953);
                ...
                case 4:
                    if (MechDrive.GetTaskState() == Task_State.INIT ||
                            MechDrive.GetTaskState() == Task_State.READY ||
                            MechDrive.GetTaskState() == Task_State.DONE) {
                        MechDrive.SetTargets(-1, 1200, 0.4, 1);
                        programOrder++;
                    }
                    break;
                ...
                case 9:
                    if (ET.milliseconds() > 700) {
                        if (MechDrive.GetTaskState() == Task_State.READY ||
                                MechDrive.GetTaskState() == Task_State.DONE) {
                            if (repeat == 0) {
                                MechDrive.SetTargets(-92, 790, 0.4, 1);
                            }
                            else if (repeat == 1) {
                                MechDrive.SetTargets(-92, 690, 0.4, 1);
                            }
                            programOrder++;
                        }
                    }
...
//                              MechDrive.SetTargets(90, 920, 0.4, 1);
                ...
                case 17:
                    if (RailRight.getCurrentPosition() > 2000) {
                        if (MechDrive.GetTaskState() == Task_State.READY ||
                                MechDrive.GetTaskState() == Task_State.DONE) {
                            MechDrive.SetTargets(-1, 130, 0.4, 1);
                            programOrder++;
                        }
                    }
                    break;
...
//                    }
                ...
                case 24:
                    if (MechDrive.GetTaskState() == Task_State.READY ||
                            MechDrive.GetTaskState() == Task_State.DONE) {
                        MechDrive.SetTargets(180, 350, 0.4, 1);
                        SetAttachmentPosition(0, -1020);
                        programOrder++;
                    }
                    break;
