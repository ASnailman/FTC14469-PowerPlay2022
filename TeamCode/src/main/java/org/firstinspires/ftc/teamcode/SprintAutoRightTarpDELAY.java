...
@Autonomous(name = "SprintAutoRightTarpDELAY", group = "MecanumDrive")
public class SprintAutoRightTarpDELAY extends LinearOpMode {
                ...
                case 18:
                    if (MechDrive.GetTaskState() == Task_State.READY ||
                        ...
                        if (posOne) {
                            ...
                            MechDrive.SetTargets(90, 2800, 0.8, 1);
                            SetAttachmentPosition(0, 2000);
                            SetExtendingPosition(0);
                            ET.reset();
                        }
                        programOrder++;
