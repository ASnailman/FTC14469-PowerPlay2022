...
//                        LeftClaw.setPosition(1);
                ...
                if (!button_x_already_pressed2) {
                    if (gamepad2.x) {
                        ...
                        coneStackMode = false;
                        Claw.setPower(-1);
                        RailControlV2.SetTargetPosition(179, -1, 1);
                        SetBasePosition(0);
                        button_x_already_pressed2 = true;
                    }
                } else {
                ...
                if (!button_a_already_pressed2) {
                    if (gamepad2.a) {
                        ...
                        coneStackMode = false;
                        Claw.setPower(-1);
                        RailControlV2.SetTargetPosition(286, -1, 1);
                        SetBasePosition(0);
                        button_a_already_pressed2 = true;
                    }
                } else {
                ...
                if (!button_b_already_pressed2) {
                    if (gamepad2.b) {
                        ...
                        coneStackMode = false;
                        Claw.setPower(-1);
                        RailControlV2.SetTargetPosition(411, -1, 1);
                        SetBasePosition(0);
                        button_b_already_pressed2 = true;
                    }
                } else {
                ...
                if (!button_y_already_pressed2) {
                    if (gamepad2.y) {
                        ...
                        coneStackMode = false;
                        Claw.setPower(-1);
                        RailControlV2.SetTargetPosition(519, -1, 1);
                        SetBasePosition(0);
                        button_y_already_pressed2 = true;
                    }
                } else {
