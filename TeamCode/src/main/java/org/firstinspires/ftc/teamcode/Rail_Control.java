...
public class Rail_Control {
    ...
    public void RailTask() {
        ...
        if (run_state == Task_State.RUN || run_state == Task_State.DONE || run_state == Task_State.READY) {
            ...
            cmdLeft = pid_obj.PID_Control(target_position, 0.005, 0, 0, motor_obj_left.getCurrentPosition() );
            cmdRight = pid_obj.PID_Control(target_position, 0.005, 0, 0, motor_obj_right.getCurrentPosition() );
