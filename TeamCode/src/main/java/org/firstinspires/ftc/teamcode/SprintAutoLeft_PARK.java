...
@Autonomous(name = "SprintAutoLeft_PARK", group = "MecanumDrive")
public class SprintAutoLeft_PARK extends LinearOpMode {
                ...
                case 2:
                    if (ET.milliseconds() > 1500) {
                        if (MechDrive.GetTaskState() == Task_State.INIT ||
                            ...
                            if (posOne) {
                                MechDrive.SetTargets(-90, 1250, 0.5, 1);
                            } else if (posTwo) {
                                MechDrive.SetTargets(-90, 0, 0, 1);
                            } else if (posThree) {
                                MechDrive.SetTargets(90, 1450, 0.5, 1);
                            }
                            programOrder++;
                        }
                    }
